...
class FileCrypto(private val context: Context) {
     ...
     */
    fun encryptFileDataPasswordBased(
        fileData: ByteArray,
        metadata: String,
        password: String
    ): ByteArray {
        return try {
            ...
            try {
                ...
                throw RuntimeException(
                    "Password-based file encryption failed: ${e.message}, Legacy fallback: ${legacyE.message}",
                    e
                )
            }
        }
        ...
        return try {
            ...
            try {
                ...
                val finalData = JSONObject().apply {
                    ...
                    put(
                        "encrypted_content",
                        Base64.encodeToString(encryptedFileData, Base64.NO_WRAP)
                    )
                }
                ...
                throw RuntimeException(
                    "RSA file encryption failed: ${e.message}, Legacy fallback: ${legacyE.message}",
                    e
                )
            }
        }
    ...
    fun decryptFileDataPasswordBased(
        ...
        try {
            ...
            val jsonData =
                String(encryptedData.sliceArray(1 until encryptedData.size), Charsets.UTF_8)
